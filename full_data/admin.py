...
from full_data.models import AllData, FinancialData, InformativeData, InvestorInfo, MainData, CurrencyPrice, Area, CadastralPhoto, Category, Currency, ObjectPhoto, ProductPhoto
