...
from full_data.models import AllData, Area, Category, MainData, Status
...
from rest_framework import serializers
from full_data.models import CadastralPhoto, InformativeData, ObjectPhoto, ProductPhoto
...
from full_data.models import Currency, FinancialData
...
from rest_framework import serializers
from full_data.models import AllData, InvestorInfo
# from full_data.data_serializers import FinancialDataRetrieveCustomSerializer, InformativeProDataSerializerGet, CoordinatesSerializer, MainDataRetrieveSerializer
